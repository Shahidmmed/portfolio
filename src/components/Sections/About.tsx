          ...
          >
            <div className="about-me">
              ...
              <p>
                ...
                CSS, React and ASP.NET. User experience is a component of
                software that, in my opinion, is essential for a successful
                product.I'm incredibly passionate about UI effects, animations,
                and developing dynamic, intuitive user interfaces.
              </p>
              <p>
                I love discovering new and better ways to create seamless user
                experiences with clean, efficient, and scalable code.My main
                objective is to create something beautiful with people who bring
                out the best in me, at the end of the day.
              </p>
            </div>
            <div className="">
